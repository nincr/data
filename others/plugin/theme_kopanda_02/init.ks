...
mp.name_color = mp.name_color || "0x48D1CC";  
...
;スキップボタン
[button name="role_button" role="skip" graphic="../others/plugin/theme_kopanda_02/image/button/skip.png" enterimg="../others/plugin/theme_kopanda_02/image/button/skip2.png" x=60 y=610]

;オートボタン
[button name="role_button" role="auto" graphic="../others/plugin/theme_kopanda_02/image/button/auto.png" enterimg="../others/plugin/theme_kopanda_02/image/button/auto2.png" x=130 y=610]
...
;クイックセーブボタン
[button name="role_button" role="quicksave" graphic="../others/plugin/theme_kopanda_02/image/button/qsave.png" enterimg="../others/plugin/theme_kopanda_02/image/button/qsave2.png" x=340 y=610]

;クイックロードボタン
[button name="role_button" role="quickload" graphic="../others/plugin/theme_kopanda_02/image/button/qload.png" enterimg="../others/plugin/theme_kopanda_02/image/button/qload2.png" x=410 y=610]
...
;メッセージウィンドウ非表示ボタン
[button name="role_button" role="window" graphic="../others/plugin/theme_kopanda_02/image/button/close.png" enterimg="../others/plugin/theme_kopanda_02/image/button/close2.png" x=550 y=610]

;フルスクリーン切替ボタン
[button name="role_button" role="fullscreen" graphic="../others/plugin/theme_kopanda_02/image/button/screen.png" enterimg="../others/plugin/theme_kopanda_02/image/button/screen2.png" x=620 y=610]

;メニュー呼び出しボタン（※ロールボタンを使うなら不要）
[button name="role_button" role="menu" graphic="../others/plugin/theme_kopanda_02/image/button/menu.png" enterimg="../others/plugin/theme_kopanda_02/image/button/menu2.png" x=690 y=610]

;コンフィグボタン（※sleepgame を使用して config.ks を呼び出しています）
[button name="role_button" role="sleepgame" graphic="../others/plugin/theme_kopanda_02/image/button/sleep.png" enterimg="../others/plugin/theme_kopanda_02/image/button/sleep2.png" x=760 y=610 storage="../others/plugin/theme_kopanda_02/config.ks"]
